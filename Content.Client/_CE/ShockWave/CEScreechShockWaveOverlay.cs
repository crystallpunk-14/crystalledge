...
public sealed class CEScreechShockWaveOverlay : Overlay, IEntityEventSubscriber
{
    ...
    private readonly EntProtoId _shaderProto = "CEScreechShockWave";

    public CEScreechShockWaveOverlay()
    {
    ...
    protected override bool BeforeDraw(in OverlayDrawArgs args)
    {
        ...
        var query = _entMan.EntityQueryEnumerator<CEScreechShockWaveComponent, TransformComponent>();
