...
namespace Content.Client._CE.MagicEnergy;

/// <summary>
/// Overlay that draws CE mana bars above entities with <see cref="BatteryComponent"/>.
...
public sealed class CEEntityManaBarOverlay : Overlay
{
    ...
    protected override void Draw(in OverlayDrawArgs args)
    {
        ...
        var query = _entManager.AllEntityQueryEnumerator<BatteryComponent, SpriteComponent, TransformComponent>();
        while (query.MoveNext(out var uid, out var mana, out var spriteComponent, out var xform))
        {
            ...
            var ratio = Math.Clamp(mana.LastCharge / mana.MaxCharge, 0f, 1f);
