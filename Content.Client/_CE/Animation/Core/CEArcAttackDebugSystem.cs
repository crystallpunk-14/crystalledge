...
/// <summary>
/// Client-side system that listens for <see cref="CEItemAttackEvent"/> and feeds
...
public sealed class CEArcAttackDebugSystem : EntitySystem
{
    ...
    {
        base.Initialize();
        SubscribeLocalEvent<CEItemAttackEvent>(OnArcAttackFired);
    }

    private void OnArcAttackFired(CEItemAttackEvent ev)
    {
