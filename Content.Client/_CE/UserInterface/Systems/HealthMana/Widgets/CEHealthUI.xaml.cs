...
public sealed partial class CEHealthUI : UIWidget
{
    ...
    protected override void FrameUpdate(FrameEventArgs args)
    {
        ...
        if (!_entManager.TryGetComponent<MobStateComponent>(player, out var mobState) ||
            !_entManager.TryGetComponent<DamageableComponent>(player, out var damageable) ||
            !_entManager.TryGetComponent<MobThresholdsComponent>(player, out var thresholds))
        {
            Visible = false;
            return;
        }
        ...
        Visible = true;
        UpdateHealthDisplay(player, mobState, damageable, thresholds);
    }
