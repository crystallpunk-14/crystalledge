...
public sealed partial class DungeonSystem : SharedDungeonSystem
{
    ...
    public override void Initialize()
    {
        ...
        //_console.RegisterCommand("dungen", Loc.GetString("cmd-dungen-desc"), Loc.GetString("cmd-dungen-help"), GenerateDungeon, CompletionCallback); //Disabled for CrystallEdge
