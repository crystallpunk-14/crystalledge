...
ent-CEChestWoodenFilled = { ent-CEChestWooden }
    .desc = { ent-CEChestBase.desc }
    .suffix = Наполненный
...
ent-CEActionRespawn = Возродиться
    .desc = Вернуться в лобби для начала новой игры.

ent-CEActionZLevelUp = Подняться
    .desc = Переместиться на один Z-уровень вверх

ent-CEActionZLevelDown = Спуститься
    .desc = Переместиться на один Z-уровень вниз

ent-CEActionToggleLookUp = Посмотреть вверх
    .desc = Вы поднимаете голову и смотрите на небо.

ent-CEClothingBackBackpackBase = None

ent-CEClothingBackSatchelBase = None

ent-CEClothingBackBackpack = рюкзак
    .desc = Стандартный рюкзак с приличным местом для хранения. Идеально подходит для повседневного использования. Прикрывает спину от ударов!

ent-CEClothingBackSatchel = деревенская сумка
    .desc = Кожаная сумка ручной работы с деревенским шармом. Предоставляет скромное место для хранения в традиционном стиле. Можно носить через плечо.

ent-CEClothingAccessoryAmuletFireStar = Жгучее лезвие Лаозела
    .desc = Мистический амулет в форме огня. Увеличивает весь исходящий [color=#ff4500]урон от огня[/color] на 3.

ent-CEClothingAccessoryAmuletIceStar = Звезда Мьерзы
    .desc = Мистический амулет в форме замёрзшей звезды. Увеличивает весь исходящий [color=#05eeff]урон от холода[/color] на 3.

ent-CEClothingAccessoryAmuletVitality = амулет жизнестойкости
    .desc = Амулет, усиливающий способность тела к исцелению, увеличивая всё входящее лечение на 5.

ent-CEClothingAccessoryBezoar = безоар
    .desc = Защищает носителя от отравления.

ent-CEClothingAccessoryCrownOfThorns = терновый венец
    .desc = Когда вы получаете урон в ближнем бою, вы наносите 6 физического урона атакующему.

ent-CEClothingAccessoryEnergyGeode = энергетическая жеода
    .desc = Треснувшая жеода, содержащая энергетические кристаллы. Увеличивает [color=#3296fa]максимальный запас маны владельца на 20[/color] и может использоваться как накопитель энергии.

ent-CEClothingAccessoryFighterGloves = боевые перчатки
    .desc = Тяжёлые боевые перчатки. Увеличивают весь исходящий [color=#05eeff]физический урон[/color] в ближнем бою на 3.

ent-CEClothingAccessoryFlamingStone = пылающий камень
    .desc = Ваши атаки в ближнем бою поджигают цели [color=#ff4500]огнём[/color]

ent-CEClothingAccessoryNinjaBandana = бандана ниндзя
    .desc = Увеличивает максимальную [color=#32cd32]выносливость[/color] на 3

ent-CEClothingAccessoryRingFire = кольцо огня
    .desc = Защитное кольцо, ограждающее носителя от жара огня.

ent-CEClothingAccessoryRingFrost = кольцо мороза
    .desc = Защитное кольцо, ограждающее носителя от холода.

ent-CEClothingAccessoryBase = None

ent-CEClothingArmorChainmail = кольчуга
    .desc = TODO

ent-CEClothingArmorBase = броня
    .desc = Защищает внутренние органы от встречи с острыми инородными предметами.

ent-CEClothingShirtBase = рубашка
    .desc = Прикрой свою наготу!

ent-CEClothingPantsBase = штаны
    .desc = Штаны, чтобы защитить бёдра от холода.

ent-CEClothingCloakBase = плащ
    .desc = TODO

ent-CEClothingHeadBase = головной убор
    .desc = TODO

ent-CEClothingShoesBase = обувь
    .desc = TODO

ent-CEClothingGeneralPantsDark = { ent-CEClothingPantsBase }
    .desc = { ent-CEClothingPantsBase.desc }

ent-CEClothingGeneralShoesAristocraticBlack = { ent-CEClothingShoesBase }
    .desc = { ent-CEClothingShoesBase.desc }

ent-CEClothingGeneralShoesLongLeatherBoots = { ent-CEClothingShoesBase }
    .desc = { ent-CEClothingShoesBase.desc }

ent-CEClothingKnightCloakCapeRed = { ent-CEClothingCloakBase }
    .desc = { ent-CEClothingCloakBase.desc }

ent-CEClothingKnightCloakFurRed = { ent-CEClothingCloakBase }
    .desc = { ent-CEClothingCloakBase.desc }

ent-CEClothingKnightShirtFighter = { ent-CEClothingShirtBase }
    .desc = { ent-CEClothingShirtBase.desc }

ent-CEClothingMageCloakCape = { ent-CEClothingCloakBase }
    .desc = { ent-CEClothingCloakBase.desc }

ent-CEClothingMageHeadTriangular = { ent-CEClothingHeadBase }
    .desc = { ent-CEClothingHeadBase.desc }

ent-CEClothingMagePantsBlue = { ent-CEClothingPantsBase }
    .desc = { ent-CEClothingPantsBase.desc }

ent-CEClothingMagePantsPurple = { ent-CEClothingPantsBase }
    .desc = { ent-CEClothingPantsBase.desc }

ent-CEClothingMageShirtBlue = { ent-CEClothingShirtBase }
    .desc = { ent-CEClothingShirtBase.desc }

ent-CEClothingMageShirtBlueJacket = { ent-CEClothingShirtBase }
    .desc = { ent-CEClothingShirtBase.desc }

ent-CEClothingMageShirtOpenPurpleDress = { ent-CEClothingShirtBase }
    .desc = { ent-CEClothingShirtBase.desc }

ent-CEClothingMageShirtPurple = { ent-CEClothingShirtBase }
    .desc = { ent-CEClothingShirtBase.desc }

ent-CEClothingMageShirtWhitePurpleDress = { ent-CEClothingShirtBase }
    .desc = { ent-CEClothingShirtBase.desc }

ent-CEClothingPriestPantsDark = { ent-CEClothingPantsBase }
    .desc = { ent-CEClothingPantsBase.desc }

ent-CEClothingPriestPantsWhite = { ent-CEClothingPantsBase }
    .desc = { ent-CEClothingPantsBase.desc }

ent-CEClothingPriestShirtDark = { ent-CEClothingShirtBase }
    .desc = { ent-CEClothingShirtBase.desc }

ent-CEClothingPriestShirtWhite = { ent-CEClothingShirtBase }
    .desc = { ent-CEClothingShirtBase.desc }

ent-CEClothingPriestShirtWhiteWide = { ent-CEClothingShirtBase }
    .desc = { ent-CEClothingShirtBase.desc }
...
ent-CERoomPasswayMarker = маркер соединения комнат

ent-CESpawnPointJob = Точка появления игроков

ent-CEBaseBiomeSpawner = спаунер биома
    .desc = Спаун различных биомов на карте.

ent-CEBiomeSpawnerGrassland = { ent-CEBaseBiomeSpawner }
    .desc = { ent-CEBaseBiomeSpawner.desc }
    .suffix = Луга

ent-CEActionFireConstructExplosion = Взрыв огненного конструкта
    .desc = TODO

ent-CEActionFireConstructFirebolt = Огненная стрела
    .desc = Вы бросаете 3 огненных шара, которые взрываются при ударе, поджигая землю и существ [color=#ff8a05]огнём[/color].

ent-CEProjectileFireConstructFirebolt = снаряд огненной стрелы

ent-CEMobFlem2 = { ent-CEMobFlem }
    .desc = { ent-CEMobFlem.desc }
    .suffix = Огонь

ent-CEMobFlem3 = { ent-CEMobFlem }
    .desc = { ent-CEMobFlem.desc }
    .suffix = Мороз

ent-CEActionGnomeJump = прыжок огненной слизи
    .desc = Слизь прыгает в сторону цели.

ent-CEActionGnomeThrowStone = Бросить камень
    .desc = Вы бросаете камень во врага, нанося незначительный урон.

ent-CEProjectileGnomeStone = снаряд гнома

ent-CEActionGnomeHeal = Лечение ран
    .desc = Вы восстанавливаете [color=#1defa9]5 здоровья[/color] существу, которого касаетесь.

ent-CEActionGnomeThrowRat = Бросок крысы
    .desc = Вы бросаете крысу во врага.

ent-CEProjectileGnomeRat = снаряд крысы гнома

ent-CEActionFireSlimeJump = прыжок огненной слизи
    .desc = Слизь прыгает в сторону цели.
...
ent-CEActionViatorManaSteal = Кража маны

ent-CEEffectViatorStealMana = { ent-CEEffectAreaHealingTelegraphy }
    .desc = { ent-CEBaseMagicImpact.desc }
    .suffix = VFX

ent-CEActionViatorIcicles = Выстрел

ent-CEProjectileViatorIcicle = None

ent-CEActionViatorMelee = Рывковая атака в ближнем бою

ent-CEMobBossBase = None
    .suffix = Босс
...
ent-CEIronKey = железный ключ
    .desc = Потёртый железный ключ. Подходит к золотому замку.

ent-CEKnowledgeBook_Acceleration = ускорение
    .desc = Этот небольшой том содержит подробный рецепт приготовления зелья, временно увеличивающего скорость передвижения.

ent-CEKnowledgeBook_BasicAlchemy = основы алхимии
    .desc = Руководство по алхимии для полных новичков. В этой книге описаны основные рецепты приготовления самых распространённых и простых зелий.
...
ent-CEEffectPotionHealing = { ent-CEBaseMagicImpact }
    .desc = { ent-CEBaseMagicImpact.desc }
...
ent-CEPotionEmptyMedium = { ent-CEPotionBase }
    .desc = { ent-CEPotionBase.desc }

ent-CEPotionEmptySmall = { ent-CEPotionBase }
    .desc = { ent-CEPotionBase.desc }

ent-CEPotionEmptyCube = { ent-CEPotionBase }
    .desc = { ent-CEPotionBase.desc }
...
ent-CEEffectTakeDamageTempShieldPhysical = { ent-CEBaseMagicImpact }
    .desc = { ent-CEBaseMagicImpact.desc }
...
ent-CEClothingPriestCloakWhite = { ent-CEClothingCloakBase }
    .desc = { ent-CEClothingCloakBase.desc }
