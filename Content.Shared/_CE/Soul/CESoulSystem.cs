...
/// <see cref="CESoulContainerComponent"/>.
...
public sealed class CESoulSystem : EntitySystem
{
    ...
    /// </summary>
    public int GetSouls(EntityUid uid, CESoulContainerComponent? comp = null)
    {
    ...
    /// </summary>
    public int GetMaxSouls(EntityUid uid, CESoulContainerComponent? comp = null)
    {
        if (!Resolve(uid, ref comp, false))
            return 0;
    ...
    /// </summary>
    public bool TrySetSouls(EntityUid uid, int amount, CESoulContainerComponent? comp = null)
    {
        if (!Resolve(uid, ref comp, false))
            return false;
    ...
    /// Returns false if the entity has no container.
    /// </summary>
    public bool TryAddSouls(EntityUid uid, int amount, CESoulContainerComponent? comp = null)
    {
        if (!Resolve(uid, ref comp, false))
            return false;
    ...
    /// </summary>
    public bool TryRemoveSouls(EntityUid uid, int amount, CESoulContainerComponent? comp = null)
    {
        if (!Resolve(uid, ref comp, false))
            return false;
