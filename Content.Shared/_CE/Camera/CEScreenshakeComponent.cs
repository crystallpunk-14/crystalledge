...
public sealed partial class CEScreenshakeComponent : Component
{
    /// <summary>
    ...
    public HashSet<CEScreenshakeCommand> Commands = new();
...
public partial record CEScreenshakeCommand(CEScreenshakeParameters? Translational, CEScreenshakeParameters? Rotational, TimeSpan Start, TimeSpan CalculatedEnd);
...
public partial record CEScreenshakeParameters()
{
    /// <summary>
